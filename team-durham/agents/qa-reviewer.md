...
model: opus
color: yellow
tools: ["Read", "Grep", "Agent", "allura-brain_memory_search", "allura-brain_memory_list", "allura-brain_memory_get", "MCP_DOCKER_execute_sql", "MCP_DOCKER_query_database", "MCP_DOCKER_allura-team-durham-read_neo4j_cypher"]
---
---

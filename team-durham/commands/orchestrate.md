...
3. Read `.claude/agents/` for the Team Durham agent roster
...
- **Tool namespace rule:** Claude Code uses `mcp__allura-brain__*`; OpenCode uses `allura-brain_*`. Use whichever exists.

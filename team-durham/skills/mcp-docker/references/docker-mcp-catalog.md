...
- **Publisher**: perplexica
- **Description**: Self-hosted AI search engine with web search and content extraction
- **Tools**: search, extract, research, crawl, map
- **Config**: api_url
- **Docker**: perplexica-mcp
...
**Search APIs:**
```
mcp_find(query="perplexica tavily brave perplexity google search")
```

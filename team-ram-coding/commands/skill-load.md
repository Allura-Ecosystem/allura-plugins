...
| -------- | --------- | ----------- |
| `brooks-architect` | Architecture and orchestration | All tools (planning only) |
| `jobs-intent-gate` | Intent and scope | Read + planning tools |
| `scout-recon` | Discovery and reconnaissance | Search tools only |

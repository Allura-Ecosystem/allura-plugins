...
/skill-propose task-management # Workflow specialist (@Brooks)
...
| `task-management`          | `@Brooks`    | Task tracking, deps, and routing             |
| `system-design`            | `@Fowler`    | Strategic planning                           |
| `frontend-design`          | `@Pike`      | Interface and accessibility review           |
...
| `mcp-docker`               | `@Brooks`    | Docker-based MCP management                  |
| `mcp-docker-memory-system` | `@Scout`     | Memory system MCP operations                 |
| `memory-client`            | `@Brooks`    | Allura Brain memory operations               |
| `systematic-debugging`     | `@Scout`     | Systematic debugging with memory             |

...
**Read `../config/team-ram-coding.json` before any other startup action.**
...
| **Can Delegate To** | woz-builder, scout-recon, jobs-intent-gate, fowler-refactor-gate, pike-interface-review |
